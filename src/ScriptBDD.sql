...
(1, 5, "Terrritorialistes agressifs", "Les unités avec ce code ont la capacité Objectif Sécurisé. Si une figurine d'une telle unité possède déjà cette aptitude, la figurine compte comme une figurine supplémentaire lors de la détermination du contrôle d'un pion d'objectif. --Chaque fois qu'une attaque ayant une caractéristique de pénétration d'armure de - 1 est allouée à une figurine ayant ce code, si l'unité de la figurine est entièrement dans la zone de déploiement de son contrôleur, cette attaque a une caractéristique de pénétration d'armure de 0 à la place. --Quand le Protocole du Gardien Éternel devient actif pour votre armée, si chaque unité de votre armée (à l'exception des unités de l'AGENT DYNASTIQUE et du C'TAN SHARD) possède ce code, vous pouvez sélectionner les deux directives de ce protocole de commandement au lieu d'une seule."),
(1, 6, "Avancé implacable", "Chaque fois qu'un test de Moral est effectué pour une unité avec ce code, vous pouvez relancer ce test. --Au lieu de suivre les règles normales pour les armes à tir rapide, les figurines ayant ce code tirant avec des armes à tir rapide effectuent deux fois plus d'attaques si la cible de la figurine qui tire est à 18 pouce. --Quand le Protocole du Tyran Conquérant devient actif pour votre armée, si toutes les unités de votre armée (à l'exception des unités de l'AGENT DYNASTIQUE et du C'TAN SHARD) possèdent ce code, vous pouvez sélectionner les deux directives de ce protocole de commandement au lieu d'une seule.");
...
(1, "Augmentation mécanique", "A la fin de votre phase de mouvement, vous pouvez sélectionner une unité amie NECRONS BASE à 6 pouce de cette figurine. Si vous le faites, lancez un D3 et consultez le tableau ci-dessous : --1. Jusqu'à la fin de la bataille, ajoutez 1 à la caractéristique de Force des figurines de cette unité. --2. Jusqu'à la fin de la bataille, ajoutez 1 à la caractéristique d'endurance des figurines de cette unité. --3. Jusqu'à la fin de la bataille, améliorez de 1 la caractéristique de capacité de tir des figurines de cette unité."),
...
SELECT num_faction, false, "Maraudeur Canoptek", nom_faction, "Soutien", "(8 M, 5 CC, 2 A, si entre 4-6 PV.) --(6 M, 6 CC, 1 A si entre 1-3 PV.)", 140, 1, 1, 10, 4, 4, 6, 6, 12, 3, 10, 3
FROM Faction 
WHERE num_faction = 1;
